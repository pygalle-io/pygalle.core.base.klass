...
copyright = '%d, %s' % (SETTINGS['copyright']['year'], SETTINGS['copyright']['author']['name'])
author = SETTINGS['copyright']['author']['name']
...
release = SETTINGS['package']['version']
...
htmlhelp_basename = '%s.doc' % (SETTINGS['package']['name'])
